...
<div class="container form-login">
    <div class="row content">
        ...
        <div class="col-md-6">
            <h3 class="login-text mb-3">Register</h3>
            <form action="{{ route('register') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="name">Name</label>
                    <input type="name" name="name" id="name" class="form-control-login" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password_confirmation" id="password-confirm" class="form-control-login" value="{{ old('password-confirm') }}">
